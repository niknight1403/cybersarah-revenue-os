...
export const users = mysqlTable("users", {
  ...
  is21Verified: boolean("is21Verified").default(false).notNull(),
  verificationMethod: mysqlEnum("verificationMethod", ["id_check", "credit_card", "third_party_kyc"]),
  verificationTimestamp: timestamp("verificationTimestamp"),
