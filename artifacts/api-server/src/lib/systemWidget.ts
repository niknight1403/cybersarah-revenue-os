/**
 * System Status Badge Widget — HTML/JS für Landing Page
 * Zeigt live System-Gesundheit, Agenten-Status, OpenAI/Stripe Verfügbarkeit
 */
export function systemStatusBadgeHtml(): string {
  const w = [
    '<div id="sys-badge" style="position:fixed;top:10px;right:10px;z-index:99997;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;">',
